...
window.addEventListener("DOMContentLoaded", () => {
  ...
  const skor    = getValue("skor", "ek_level6_skor", "0");
  const alasan  = getValue("alasan", "ek_level6_alasan", "Level 6 selesai!");
  ...
  document.getElementById("cgMsg").innerHTML =
    ...
    `Kamu sudah latihan mengubah pikiran jadi lebih positif dan menenangkan 🌿`;
